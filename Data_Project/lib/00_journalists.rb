...
def handle_size_sort # 6
    puts "Voici les pseudos en partant du plus court pour arriver au plus long : #{journa_list.sort_by(&:length)}." #marche aussi avec size
end
